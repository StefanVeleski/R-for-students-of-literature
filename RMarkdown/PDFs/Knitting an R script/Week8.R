...
nrc_joy <- get_sentiments("nrc") %>% # tidy text function that extracts the values of 3 sentiment lexicons
...
#' Getting a particular novel as a single character string, ready for syuzhet analysis. Let's first load the Austen novels from scratch, so that we have a clean slate
